...
if __name__ == "__main__":
    ...
    makeLabelsSetDim("/mnt/data/kai/VinDr_datasets/FULL_1024_PAD_annotations/mergedAnnoTrainEncompass_03.csv", "/mnt/data/kai/VinDr_YOLOv8_experiments/datasets/FULL_1024_brightnessEQ_FIXED/labels/train", (1024, 1024), classesDict)
    print("Making testing set")
    makeLabelsSetDim("/mnt/data/kai/VinDr_datasets/FULL_1024_PAD_annotations/mergedAnnoTestEncompass_03.csv", "/mnt/data/kai/VinDr_YOLOv8_experiments/datasets/FULL_1024_brightnessEQ_FIXED/labels/val", (1024, 1024), classesDict)
