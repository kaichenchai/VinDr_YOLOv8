...
wandb.init(project="VinDr_YOLOv8", job_type="training", name = "220824_YOLOv8s_brightnessEQ_FIXED_encompassBB03",
config={
    "epochs": 50,
...
model.train(project = "train_VinDr_YOLOv8",
            data = dataset_name,
            name = "220824_YOLOv8s_brightnessEQ_FIXED_encompassBB03",
            batch = 16,
            epochs = 50,
            imgsz = 1024,
            plots = True,
